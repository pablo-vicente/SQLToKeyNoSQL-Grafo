...
public class NoSQLTargets extends javax.swing.JDialog {
     ...
     */
    public NoSQLTargets(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jListAlias = new javax.swing.JList();
        ...
        jListAlias.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                jListAliasValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(jListAlias);
        ...
        jLabel2.setText("NoSQL DB");

        jComboBoxTarget.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MongoDB", "Cassandra", "Redis" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jComboBoxTarget, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextFieldAlias, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void loadList (){
        ...
        for (NoSQL target: dic.getTargets())
            listModel.addElement(target);
        jListAlias.setModel(listModel);
    }
    
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        loadList();
        jComboBoxTarget.removeAllItems();
        jComboBoxTarget.addItem(new MongoConnector());
    ...
    private void jListAliasValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListAliasValueChanged
        loadNoSQL((NoSQL)jListAlias.getSelectedValue());
    }//GEN-LAST:event_jListAliasValueChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoSQLTargets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JList jListAlias;
