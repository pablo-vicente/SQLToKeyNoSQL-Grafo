...
public class ExecutionEngine {
    ...
    public boolean insertData(String table, LinkedList<String> columns, ArrayList<String> values) {
        ...
        connection.put(dic, tableDb, key, columns, values);
...
//        cols.add("_key");
        ...
        ArrayList<String[]> tuples = ds.getData();
        ...
        for(String [] tuple : tuples){
            ...
            String key = getKey(t, t.getAttributes(), val);
...
//            String k = tuple[cols.size()-1];
            ...
            //tuple[cols.indexOf()]
//            cols.remove("_key");
            t.getTargetDB().getConection().put(dic, t, key, cols, val);
        }
